...
<html lang="es">
  <head>
    ...
    <title>G-Magis - Comunidades</title>
  ...
  <body>
    <nav class="navbar fixed-top bg-dark flex-md-nowrap p-0 shadow navbar-fixed-top">
      ...
      <span>
        <strong class="marginnav" id="PaginaPrincipal" >Comunidades</strong>
      </span>
    ...
    <section id="contenido" class="seccion2Home">
      ...
      <div class="card-columns">
        <?php
          $archivo = fopen("../data/comunidades.json","r");
          $linea = "";
          while($linea = fgets($archivo)){
            $contenido = json_decode($linea,true);
            echo
            '<div class="card">
              <img class="card-img-top" src="../img/comunidades/'.$contenido["imagen"].'">
              <div class="card-body">
                ...
                <div><p>Seguidores:  '.$contenido["seguidores"].'</p></div>
                <span<h5 class="titulos1">'.$contenido["titulo"].'</h5></span>
              </div>
